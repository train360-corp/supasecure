...
CREATE OR REPLACE FUNCTION public.is_authorized(tenant uuid, permission membership_type)
 RETURNS boolean
 LANGUAGE plpgsql
 STABLE
AS $function$DECLARE
...
BEGIN
  ...
  CASE permission::text
    WHEN 'ADMIN' THEN
      RETURN membership.type = 'ADMIN'::"public"."membership_type";
    WHEN 'USER' THEN
      RETURN membership.type = 'USER'::"public"."membership_type" OR membership.type = 'ADMIN'::"public"."membership_type";
    ELSE
